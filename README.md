...
5. Run Jekyll and watch files by running `npx gulp`

Please note that any changes made to the `_config.yml` will require that you stop gulp and start it again.
...
While running `npx gulp` modify any of the files in the `assets/scss/` folder and your browser will update automatically. No reload required!
